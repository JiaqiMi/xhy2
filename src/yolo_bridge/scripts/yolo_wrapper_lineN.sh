...
OUTPUT_TYPE=$(get_param output_type uniform_path)
LINE_SAMPLE_COUNT=$(get_param line_sample_count 20)
...
LINE_TOPIC=$(get_param line_topic /yolo_unified/line_points)
...
echo "[yolo_wrapper] line_sample_count=${LINE_SAMPLE_COUNT}"
