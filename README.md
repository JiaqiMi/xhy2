...
auv_control: 用于驱动底层芯片的驱动代码以及程序主逻辑

stereo_depth: 双目视觉深度计算

stereo_spiltter: 双目摄像头画面划分

yolo_bridge: 封装为ros功能包的yolo网络

流程结构：

![1757597638881](image/README/1757597638881.png)
...
```bash
rosrun auv_control keyboard_control.py
```

then input runmode to run
